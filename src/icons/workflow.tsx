...
export default function WorkflowIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg
            width="24"
            height="24"
        ...
        >
            ...
            />
            <path
                d="M12.0002 2H8.0002C7.3502 3.95 7.3502 6.05 8.0002 8H12.0002C12.6502 6.05 12.6502 3.95 12.0002 2Z"
                stroke="#737373"
                stroke-width="1.5"
                stroke-linecap="round"
                stroke-linejoin="round"
