  ...
  return (
    <div className="p-2 flex justify-end items-center w-full gap-2">
      ...
      <button onClick={onCreateNewItem} className="bg-primary px-3 py-[11px]">
        {type === 'chat' && <EditIcon className="size-6" />}
        {type === 'project' && showCreateButton && (
          <button className="bg-primary w-fit py-2.5 px-6 text-sm font-medium leading-5 shadow-sm rounded-xs text-white whitespace-nowrap">
            New Project
          </button>
        )}
      </button>
