...
function DirectoryUserAvatar({ user }: { user: Employee | Contractor | Team | Vendor }) {
  ...
  const employeeColumns = [
    {
      ...
      label: 'Name',
      render: (_: unknown, employee: Employee) => <DirectoryUserAvatar user={employee} />,
    },
    {
  ...
  const contractorColumns = [
    {
      ...
      label: 'Name',
      render: (_: unknown, contractor: Contractor) => <DirectoryUserAvatar user={contractor} />,
    },
    {
  ...
  const vendorColumns = [
    {
      ...
      label: 'Name',
      render: (_: unknown, vendor: Vendor) => <DirectoryUserAvatar user={vendor} />,
    },
    {
        ...
        <Tabs value={activeMainTab} onValueChange={setActiveMainTab} className="w-full">
          ...
          <TabsContent value="Location Management" className="space-y-6">
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">Advanced location management features coming soon.</p>
            </div>
          </TabsContent>
        </Tabs>
      </div>
